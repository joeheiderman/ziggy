...
namespace finch {
     ...
     */
    //% weight=28 blockId="setTurn" block="Finch Turn %direction| at %speed| \\% for %angle|°"
    //% speed.min=0 speed.max=100
     ...
     * @param distance the discance to travel in cm
     */
    //% weight=28 blockId="startMotors" block="Finch L %l_speed|% R %r_speed|%"
     ...
     */
    //% weight=28 blockId="resetEncoders" block="Finch Reset Encoders"
     ...
     */
    //% weight=28 blockId="getEncoder" block="Finch %encoder| Encoder"
     ...
     */
    //% weight=28 blockId="resetEncoders" block="Finch Distance (cm)"
     ...
     */
    //% weight=28 blockId="getLight" block="Finch %light| Light"
     ...
     */
    //% weight=28 blockId="getLine" block="Finch %line| Line"
     ...
     */
    //% weight=20 blockId="getBattery" block="Finch Battery"
